...
### 📌 Нейро-гид по Ижевску — Telegram Bot
Я разработал систему RAG в виде нейронного процессора для гида по г. Ижевск, ориентированную на анализ и обработку данных из базы знаний (JSON-файл). [Ссылка на проект](https://github.com/Rustam99-eng/Neuroguide-for-the-city-of-Izhevsk)
